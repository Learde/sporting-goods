<template>
  <form class="edit-form">
    ...
    <Button
      ...
      nameEvent="toggle-mode"
      v-on:toggle-mode="toggleCategoryMode"
    >
...
export default {
  ...
  methods: {
    ...
    submitChanges: function() {
      ...
      if (this.isNewCategory && !this.errors.customCategory)
        validCategory = true;
      else if (!this.isNewCategory && !this.errors.category)
        validCategory = true;
      if (
