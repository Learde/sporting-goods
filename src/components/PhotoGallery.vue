<template>
  <div class="photo-gallery">
    <div :style="'background-image:url('+active+')'" class="photo-gallery__current">
      <div 
    ...
    <div v-if="images.length > 1" class="photo-gallery__min-images">
      <div
        :class="{'photo-gallery__min-image':true, 'photo-gallery__min-image--active': img == active}"
        v-for="img in images"
...
export default {
  ...
  methods: {
    ...
    nextPhoto() {
      const newIndex = this.images.indexOf(this.active) + 1;
